...
print(len(x_data))   # 4 >> 32개 짜리 Iterator 3개 + 남은 것들 Iterator
print(xy_data[0][0].shape) # 첫번째 iterator 내부의 첫 번째 데이터의 X (32,28,28,1)
print(xy_data[0][1].shape) # 첫번째 iterator 내부의 첫 번째 데이터의 y (32),)

print(xy_data[3][0].shape) # 마지막 iterator 내부의 첫 번째 데이터의 X (4,28,28,1)
print(xy_data[3][1].shape) # 마지막 iterator 내부의 첫 번째 데이터의 y (4,)
