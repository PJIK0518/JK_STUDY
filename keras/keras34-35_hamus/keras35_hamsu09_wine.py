...
dense_1 = Dense(40, activation ='relu')(input_1)

dense_2 = Dense(60, activation ='relu')(dense_1)
DropO_2 = Dropout(0.1)(dense_2)

dense_3 = Dense(40, activation ='relu')(DropO_2)

OutPut1 = Dense(3, activation ='softmax')(dense_3)
