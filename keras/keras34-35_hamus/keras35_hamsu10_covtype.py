...
input_1 = Input(shape=(54,))

dense_1 = Dense(30, activation ='relu')(input_1)
batch_1 = BatchNormalization()(dense_1)

dense_2 = Dense(40, activation ='relu')(batch_1)
batch_2 = BatchNormalization()(dense_2)

dense_3 = Dense(30, activation ='relu')(batch_2)
batch_3 = BatchNormalization()(dense_3)

dense_4 = Dense(30, activation ='relu')(batch_3)
batch_4 = BatchNormalization()(dense_4)

dense_5 = Dense(20, activation ='relu')(batch_4)
batch_5 = BatchNormalization()(dense_5)

dense_6 = Dense(20, activation ='relu')(batch_5)
batch_6 = BatchNormalization()(dense_6)

dense_7 = Dense(20, activation ='relu')(batch_6)
batch_7 = BatchNormalization()(dense_7)

OutPut1 = Dense(7, activation ='softmax')(batch_7)
