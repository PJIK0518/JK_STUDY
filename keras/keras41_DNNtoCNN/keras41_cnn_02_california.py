...
x_trn = x_trn.reshape(-1,2,2,2)
x_tst = x_tst.reshape(-1,2,2,2)
...
#2. 모델구성
model = Sequential()
model.add(Conv2D(10, 2, padding='same', input_shape = (2,2,2), activation='relu'))
# model.add(Dropout(0.2))

model.add(BatchNormalization())
model.add(Conv2D(10, 2, padding='same', activation='relu'))
# model.add(Dropout(0.2))
