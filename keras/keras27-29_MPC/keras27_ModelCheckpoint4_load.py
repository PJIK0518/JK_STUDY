...
model = load_model(path + 'keras27_3_save.h5')

"""
loss : 26.784467697143555
rmse : 5.175371261768913
r2 스코어 : 0.7269091708324886

"""
# model = load_model(path + 'keras26_3_save.h5')
# model.load_weights(path + 'keras26_5_save1.h5')
""" 초기 램덤 가중치
loss : 632.115234375
rmse : 25.1419019641514
r2 스코어 : -5.444962435979984
"""

# model.load_weights(path + 'keras27_MCP1.hdf5')
'''훈련된 가중치
loss : 23.70290756225586
rmse : 4.868563192796809
r2 스코어 : 0.7583283495022176

loss : 25.444910049438477
rmse : 5.044294801995466
r2 스코어 : 0.7405671268170249
'''
...
#                    patience= 10,                      # 몇 번이나 참을것이냐, 통상적으로 커야지만 너무 크면 시간 낭비가 될 수도
#                    restore_best_weights= False)        # 가장 최소 지점을 저장 한다 // Default : False, False가 성적이 더 좋을수도...
