...
### SMOTENC : 연속형 컬럼에 대해서는 보간법으로, 범주형 데이터는 투표로 진행

### https://www.kaggle.com/competitions/playground-series-s4e1/submissions
### 문자 데이터 : 종류별로 나눠서 수치화
### index, customer ID 가 같이 존재 > Customer ID가 단순히 순서대로 부여된거면 사용하기 애매
                                #  > 어떤한 의미가 있는 해석이 필요
### Surname, Geography, Gender > 문자로 된 데이터, 수치화해서 사용 할지 말지 결정
# m10_08.copy
...
#             sampling_strategy={0:500000, 1:500000},
#             )
