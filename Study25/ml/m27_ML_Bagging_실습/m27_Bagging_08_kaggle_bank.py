...
# DecisionTreeRegressor  점수: 0.7928986912263694

# BaggingRegressor + DTR 점수: 0.8453708191953466 >> 직접 DTR을 Bagging 시킨 모델 : 점수 또이또이
            # bootstrap = True
            
# BaggingRegressor + DTR 점수: 0.7947164323800291
            # bootstrap = False
            # Sample 데이터 중복 허용
            
# RandomForestRegressor  점수: 0.8503999030538051 >> DTR이 Bagging 되어있는 모델  : 점수 또이또이       


# {'target': 0.8596703829374697,
#  'params': {'colsample_bylevel': 0.9760569297438024,
#             'colsample_bytree': 0.9487791605991187,
#             'gamma': 5.0, 
#             'learning_rate': 0.1, 
#             'max_bin': 168.57788409672938,
#             'max_depth': 10.0, 
#             'min_child_samples': 57.31890005480306,
#             'min_child_weight': 23.641313146121625, 
#             'n_estimator': 229.62724842593573,
#             'num_leaves': 31.5744158281984, 
#             'reg_alpha': 4.775325454544625, 
#             'reg_lambda': 55.78476968903876, 
#             'subsample': 1.0}}         
