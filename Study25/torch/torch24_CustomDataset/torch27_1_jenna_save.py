...
for e in range(1, EPOCHS+1):
    ...
    trn_lss = TRAIN(model, loss, optimizer, TQDM)
    print(f'epo : {e}')
    print(f'lss : {trn_lss.item()}')
...
print('성능 개구리', tst_lss.item())
# 성능 개구리 0.0518173910677433

### save ###
path_save = './Study25/_data/kaggle/jena/save/'
torch.save(model.state_dict(), path_save + 'jena_practice.pth')
