...
class Model(nn.Module):
    def __init__(self, ID, OD):
        super().__init__()
        self.lin1 = nn.Linear(ID, 64)
        self.lin2 = nn.Linear(64, 32)
        self.lin3 = nn.Linear(32, 16)
        self.lin4 = nn.Linear(16, 8)
        self.lin5 = nn.Linear(8, OD)
        self.relu = nn.ReLU()
...
# loss : 0.24784749746322632
# accu : 0.9722222222222222