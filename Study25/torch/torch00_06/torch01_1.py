# torch 라는 API를 꺼내오는 방식...!!
# tensorflow는 tensor 형태의 데이터로 자동 변환 후 계산
# torch에서는 torch tensor라는 형태로 직접 바꿔서 해야함
...
#2. 모델
############################################################
model = nn.Linear(1, 1)           # nn : neural network
