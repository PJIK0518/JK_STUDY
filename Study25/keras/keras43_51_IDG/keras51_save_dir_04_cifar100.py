...
x_trn = x_trn.reshape(50000, 32, 32, 3)
x_tst = x_tst.reshape(10000, 32, 32, 3)
...
model = load_model(path_S + 'k39_0617_1432_0065-2.1689.h5')
...
[Aug : + 40000]
loss : 1.6464546918869019
acc  : 0.5476999878883362
acc  : 0.5477
'''