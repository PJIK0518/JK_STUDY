...
dense_2 = Dense(64, activation ='relu')(batch_1)
DropO_2 = Dropout(0.2)(dense_2)
batch_2 = BatchNormalization()(DropO_2)

dense_3 = Dense(32, activation ='relu')(batch_2)
DropO_3 = Dropout(0.1)(dense_3)
batch_3 = BatchNormalization()(DropO_3)

OutPut1 = Dense(1)(batch_3)
