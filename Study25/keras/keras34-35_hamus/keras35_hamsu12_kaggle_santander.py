...
# 이진분류 / column 200개 / 불균형 데이터
# 성능고도화 및 GPU CPU 속도 테스트
# 33_12.copy
...
# M = LT(240,240,240,240,240, 0.15)

input_1 = Input(shape=(200,))

dense_1 = Dense(240, activation ='relu')(input_1)
dropO_1 = Dropout(0.15)(dense_1)

batch_2 = BatchNormalization()(dropO_1)
dense_2 = Dense(240, activation ='relu')(batch_2)
dropO_2 = Dropout(0.15)(dense_2)

batch_3 = BatchNormalization()(dropO_2)
dense_3 = Dense(240, activation ='relu')(batch_3)
dropO_3 = Dropout(0.15)(dense_3)

batch_4 = BatchNormalization()(dropO_3)
dense_4 = Dense(240, activation ='relu')(batch_4)
dropO_4 = Dropout(0.15)(dense_4)

batch_5 = BatchNormalization()(dropO_4)
dense_5 = Dense(240, activation ='relu')(batch_5)
dropO_5 = Dropout(0.15)(dense_5)

OutPut1 = Dense(1, activation ='softmax')(dropO_5)
