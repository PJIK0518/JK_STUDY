### keras28_MCP_save_02_california.copy
...
[AS]
loss : 0.36615708470344543
rmse : 0.6051092457001606
R2 : 0.7290777927987835
[SS] **********
loss : 0.2652963697910309
rmse : 0.5150693119067993
R2 : 0.8037053884612955
[RS]
loss : 0.3075791001319885
rmse : 0.554598242914764
R2 : 0.7724200454883554
'''
...
hist = model.fit(x_trn, y_trn, epochs = epochs, batch_size = 2000,
          verbose=2,
