...
# keras28_MCP_save_07_dacon_당뇨병.copy
...
'''
loss: 0.36668652296066284
acc : 0.8484848737716675

[MS]
loss: 0.361987441778183
acc : 0.8636363744735718

[AS] *******
loss: 0.3681667745113373
acc : 0.8939393758773804

[SS]
loss: 0.398592472076416
acc : 0.8636363744735718

[RS]
loss: 0.39161357283592224
acc : 0.8484848737716675
'''
...
def layer_tuning(a,b) :
    ...
    model = Sequential()
    model.add(Dense(a, input_dim=8, activation='relu'))
